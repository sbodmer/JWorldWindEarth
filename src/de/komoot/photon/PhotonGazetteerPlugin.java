 ...
 * @author sbodmer
 */
public class PhotonGazetteerPlugin implements WWEGazetteerPlugin {
    TinyFactory factory = null;
    App app = null;
    WorldWindow ww = null;
    
    PhotonGazetteer photon = null;
    
    public PhotonGazetteerPlugin(TinyFactory factory, WorldWindow ww) {
        this.factory = factory;
        
        photon = new PhotonGazetteer();
    ...
    public ArrayList<Result> findPlaces(String string) {
        ...
        List<PointOfInterest> pois = photon.findPlaces(string);
