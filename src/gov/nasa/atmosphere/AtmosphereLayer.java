...
public class AtmosphereLayer extends AbstractLayer {
    ...
    public void doRender(DrawContext dc) {
        ...
        try {
            ...
            Matrix projection = Matrix.fromPerspective(view.getFieldOfView(), view.getViewport().getWidth(), view.getViewport().getHeight(), 10e3, 2 * distToCenterOfPlanet + 10e3);
     ...
     * @param slices the number of longitude divisions used for the dome
     * geometry.
     * @param stacks the number of latitude divisions used for the dome
     * geometry.
     */
     ...
     * @param stacks the number of stacks - horizontal divisions
     */
    protected void drawSkyGradient(DrawContext dc, float radius, double startLat, double endLat, int slices, int stacks) {
