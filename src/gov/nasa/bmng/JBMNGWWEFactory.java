 ...
 * @author sbodmer
 */
public class JBMNGWWEFactory extends JPanel implements WWEFactory {
     ...
     */
    public JBMNGWWEFactory() {
        bundle = ResourceBundle.getBundle("gov.nasa.bmng.BMNG");
    ...
    public WWEPlugin newPlugin(Object arg) {
        return new JBMNGWWEPlugin(this, (WorldWindow) arg);
    ...
    private void initComponents() {
        ...
        LB_Name.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gov/nasa/bmng/Resources/Icons/22x22/bmng.png"))); // NOI18N
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("gov/nasa/bmng/BMNG"); // NOI18N
        LB_Name.setText(bundle.getString("factory_name")); // NOI18N

        LB_Description.setText("<html><body>\nWorldwind Blue Marble NG (2004)\n</body></html>");
