 ...
 * @author sbodmer
 */
public class JCompassWWEFactory extends JPanel implements WWEFactory {
     ...
     */
    public JCompassWWEFactory() {
        bundle = ResourceBundle.getBundle("gov.nasa.compass.Compass");
    ...
    public TinyPlugin newPlugin(Object arg) {
        return new JCompassWWEPlugin(this, (WorldWindow) arg);
    ...
    private void initComponents() {
        ...
        LB_Name.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gov/nasa/compass/Resources/Icons/22x22/compass.png"))); // NOI18N
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("gov/nasa/compass/Compass"); // NOI18N
        LB_Name.setText(bundle.getString("factory_name")); // NOI18N

        LB_Description.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        LB_Description.setText("<html><body>\nWorldwind compass layer\n</body></html>");
