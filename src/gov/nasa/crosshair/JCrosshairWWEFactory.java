 ...
 * @author sbodmer
 */
public class JCrosshairWWEFactory extends JPanel implements WWEFactory {
     ...
     */
    public JCrosshairWWEFactory() {
        bundle = ResourceBundle.getBundle("gov.nasa.crosshair.Crosshair");
    ...
    public TinyPlugin newPlugin(Object arg) {
        return new JCrosshairWWEPlugin(this, (WorldWindow) arg);
    ...
    private void initComponents() {
        ...
        LB_Name.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gov/nasa/crosshair/Resources/Icons/22x22/crosshair.png"))); // NOI18N
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("gov/nasa/crosshair/Crosshair"); // NOI18N
        LB_Name.setText(bundle.getString("factory_name")); // NOI18N

        LB_Description.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        LB_Description.setText("<html><body>\nWorldwind crosshair layer\n</body></html>");
