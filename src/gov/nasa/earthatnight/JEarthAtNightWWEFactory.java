 ...
 * @author sbodmer
 */
public class JEarthAtNightWWEFactory extends JPanel implements WWEFactory {
     ...
     */
    public JEarthAtNightWWEFactory() {
        bundle = ResourceBundle.getBundle("gov.nasa.earthatnight.EarthAtNight");
    ...
    public WWEPlugin newPlugin(Object arg) {
        return new JEarthAtNightWWEPlugin(this, (WorldWindow) arg);
    ...
    private void initComponents() {
        ...
        LB_Name.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gov/nasa/earthatnight/Resources/Icons/22x22/earthAtNight.png"))); // NOI18N
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("gov/nasa/earthatnight/EarthAtNight"); // NOI18N
        LB_Name.setText(bundle.getString("factory_name")); // NOI18N

        LB_Description.setText("<html><body>\nEarth at night tiles\n</body></html>");
