 ...
 * @author sbodmer
 */
public class JEarthAtNightWWEPlugin extends JPanel implements WWEPlugin, ActionListener {
    App app = null;
     ...
     */
    public JEarthAtNightWWEPlugin(TinyFactory factory, WorldWindow ww) {
        super();
    ...
    public void setup(App app, Object arg) {
        ...
        layer = (TiledImageLayer) bl.createFromConfigSource("config/Earth/EarthAtNightLayer.xml", null);
        layer.setName("Earth at night");
