 ...
 * @author sbodmer
 */
public class JFogWWEFactory extends JPanel implements WWEFactory {
     ...
     */
    public JFogWWEFactory() {
        bundle = ResourceBundle.getBundle("gov.nasa.fog.Fog");
    ...
    public WWEPlugin newPlugin(Object arg) {
        return new JFogWWEPlugin(this, (WorldWindow) arg);
    ...
    private void initComponents() {
        ...
        LB_Name.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gov/nasa/fog/Resources/Icons/22x22/fog.png"))); // NOI18N
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("gov/nasa/fog/Fog"); // NOI18N
