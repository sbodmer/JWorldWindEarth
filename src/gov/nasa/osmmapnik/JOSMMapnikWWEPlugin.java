 ...
 * @author sbodmer
 */
public class JOSMMapnikWWEPlugin extends JPanel implements WWEPlugin, ActionListener, ChangeListener {
    App app = null;
    TinyFactory factory = null;
    WorldWindow ww = null;
    
    OSMMapnikLayer layer = new OSMMapnikLayer();
    
    /**
     * Creates new form JTerminalsLayer
     */
    public JOSMMapnikWWEPlugin(TinyFactory factory, WorldWindow ww) {
        super();
    ...
    private void initComponents() {
        ...
        BT_Layer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gov/nasa/osmmapnik/Resources/Icons/22x22/osmmapnik.png"))); // NOI18N
