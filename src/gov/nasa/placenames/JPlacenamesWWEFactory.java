 ...
 * @author sbodmer
 */
public class JPlacenamesWWEFactory extends JPanel implements WWEFactory {
     ...
     */
    public JPlacenamesWWEFactory() {
        bundle = ResourceBundle.getBundle("gov.nasa.placenames.Placenames");
    ...
    public TinyPlugin newPlugin(Object arg) {
        return new JPlacenamesWWEPlugin(this, (WorldWindow) arg);
    ...
    private void initComponents() {
        ...
        LB_Name.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gov/nasa/placenames/Resources/Icons/22x22/placenames.png"))); // NOI18N
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("gov/nasa/placenames/Placenames"); // NOI18N
