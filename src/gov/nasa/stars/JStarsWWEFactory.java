 ...
 * @author sbodmer
 */
public class JStarsWWEFactory extends JPanel implements WWEFactory {
     ...
     */
    public JStarsWWEFactory() {
        bundle = ResourceBundle.getBundle("gov.nasa.stars.Stars");
    ...
    public WWEPlugin newPlugin(Object arg) {
        return new JStarsWWEPlugin(this, (WorldWindow) arg);
    ...
    private void initComponents() {
        ...
        LB_Name.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gov/nasa/stars/Resources/Icons/22x22/stars.png"))); // NOI18N
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("gov/nasa/stars/Stars"); // NOI18N
