 ...
 * @author sbodmer
 */
public class JViewControlsWWEFactory extends JPanel implements WWEFactory {
     ...
     * 
     */
    public JViewControlsWWEFactory() {
        bundle = ResourceBundle.getBundle("gov.nasa.viewcontrols.ViewControls");
    ...
    public TinyPlugin newPlugin(Object arg) {
        return new JViewControlsWWEPlugin(this, (WorldWindow) arg);
    ...
    private void initComponents() {
        ...
        LB_Name.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gov/nasa/viewcontrols/Resources/Icons/22x22/viewcontrols.png"))); // NOI18N
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("gov/nasa/viewcontrols/ViewControls"); // NOI18N
        LB_Name.setText(bundle.getString("factory_name")); // NOI18N

        LB_Description.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        LB_Description.setText("<html><body>\nWorldwind view controls\n</body></html>");
