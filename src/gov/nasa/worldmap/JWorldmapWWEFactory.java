 ...
 * @author sbodmer
 */
public class JWorldmapWWEFactory extends JPanel implements WWEFactory {
     ...
     */
    public JWorldmapWWEFactory() {
        bundle = ResourceBundle.getBundle("gov.nasa.worldmap.Worldmap");
    ...
    public TinyPlugin newPlugin(Object arg) {
        return new JWorldmapWWEPlugin(this, (WorldWindow) arg);
    ...
    private void initComponents() {
        ...
        LB_Name.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gov/nasa/worldmap/Resources/Icons/22x22/worldmap.png"))); // NOI18N
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("gov/nasa/worldmap/Worldmap"); // NOI18N
        LB_Name.setText(bundle.getString("factory_name")); // NOI18N

        LB_Description.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        LB_Description.setText("<html><body>\nWorldwind mini world map\n</body></html>");
