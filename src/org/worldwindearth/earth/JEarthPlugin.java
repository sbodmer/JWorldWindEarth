 ...
 * @author sbodmer
 */
public class JEarthPlugin extends JPanel implements TinyPlugin {
    ...
    public void configure(Element config) {
        if (config == null) {
            try {
                //--- Load default config
                InputStream in = app.getLoader().getResourceAsStream("org/worldwindearth/earth/Resources/Configs/Earth.xml");
