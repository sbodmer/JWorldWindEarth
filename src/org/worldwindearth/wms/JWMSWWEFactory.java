 ...
 * @author sbodmer
 */
public class JWMSWWEFactory extends JPanel implements WWEFactory {
    ...
    public JWMSWWEFactory() {
        bundle = ResourceBundle.getBundle("org.worldwindearth.wms.WMS");
    ...
    public WWEPlugin newPlugin(Object arg) {
        return new JWMSWWEPlugin(this, (WorldWindow) arg);
    ...
    private void initComponents() {
        ...
        LB_Name.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/worldwindearth/wms/Resources/Icons/22x22/wms.png"))); // NOI18N
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("org/worldwindearth/wms/WMS"); // NOI18N
